...
def random_sleep(min: float, max: float):#genera un numero random float tra min e max
...
def login(username, password, headless=True, path={"browser": None, "driver": None}, proxy=None):
    ...
    driver.get("https://instagram.com")#apre la pagina di instagram
    ...
    "/html/body/div[2]/div/div/div/div[1]/div/div/div/div[1]/section/main/article/div/div/div[2]/div[3]/button[1]"
    ).click()
    
    random_sleep(1, 4)

    #insert username in form
    try:
        username_inp = driver.find_element(By.XPATH,#find username input
        "/html/body/div[2]/div/div/div/div[1]/div/div/div/div[1]/section/main/article/div/div/div[2]/form/div[1]/div[3]/div/label/input")#insert username
        insert_text_action(username, username_inp, driver)#fill username
    ...
    #insert password in form
    try:
        password_inp = driver.find_element(By.XPATH, #find password input
        "/html/body/div[2]/div/div/div/div[1]/div/div/div/div[1]/section/main/article/div/div/div[2]/form/div[1]/div[4]/div/label/input")#insert password
        insert_text_action(password, password_inp, driver)#fill password
...
''')
    ...
    #se trova il prompt che chiede di salvare le credenziali lo accetta
    try:#primo tentativo
       driver.execute_script('''
...
'''
'''
questa fuzione supporta i proxy senza password
inoltre ha un sistem di sleep inadatto e non randomico
'''
...
'''
funzione molto simile a loginv1
'''
