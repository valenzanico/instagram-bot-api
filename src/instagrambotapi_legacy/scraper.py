...
#funzione di sleep per un tempo random tra min e max
...
'''
funzione che ritorna una lista di username instagram sfruttando le api graphql di instagram
lo script prende gli username degli utenti che seguono una determinata pagina
aggiornata a 11/12/2022
'''
...
'''
funzione che ritorna una lista di username instagram sfruttando lo scritp javascript esterno
lo script prende gli username degli utenti che hanno messo like a un post
'''
...
'''
funzione legacy che ritorna una lista di username instagram sfruttando le api graphql di instagram
lo script prende gli username degli utenti che seguono una determinata pagina
'''
